...
public class GameController {
    ...
    public void gameStart(){
        ...
        Player player1 = new Player("Dave", 10, 10, 10, 10, 10, new Dwarf(), 10, 10, new ChainMail(), true, ViewDirection.NORTH, new Thief(4, Attribute.CHARISMA, Attribute.CONSTITUTION, new ArrayList<>()));
        Player player2 = new Player("Berta", 10, 10, 10, 10, 10, new Dwarf(), 10, 10, new ChainMail(), true, ViewDirection.NORTH, new Thief(4, Attribute.CHARISMA, Attribute.CONSTITUTION, new ArrayList<>()));
        Player player3 = new Player("Hans", 10, 10, 10, 10, 10, new Dwarf(), 10, 10, new ChainMail(), true, ViewDirection.NORTH, new Thief(4, Attribute.CHARISMA, Attribute.CONSTITUTION, new ArrayList<>()));
        Player player4 = new Player("Guenter", 10, 10, 10, 10, 10, new Dwarf(), 10, 10, new ChainMail(), true, ViewDirection.NORTH, new Thief(4, Attribute.CHARISMA, Attribute.CONSTITUTION, new ArrayList<>()));
